...
function DropdownMenuTrigger({
  ...
  return (
    <DropdownMenuPrimitive.Trigger
      ...
      onPointerDown={(e) => {
        // Blur on mouse click so focus ring doesn't persist after close
...
function DropdownMenuContent({
  ...
  const openedByMouse = React.useRef(false)
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        onPointerDown={() => { openedByMouse.current = true }}
        onCloseAutoFocus={(e) => {
          if (openedByMouse.current) {
            e.preventDefault()
